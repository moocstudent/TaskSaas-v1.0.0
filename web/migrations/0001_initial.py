# -*- coding: utf-8 -*-
# Generated by Django 1.11.28 on 2023-09-11 12:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(4, '已忽略'), (5, '待反馈'), (3, '已解决'), (2, '处理中'), (1, '新建'), (6, '已关闭'), (7, '重新打开')], default=1, verbose_name='状态')),
                ...
                ('mode', models.SmallIntegerField(choices=[(2, '隐私模式'), (1, '公开模式')], default=1, verbose_name='模式')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.SmallIntegerField(choices=[(3, '其他'), (2, '收费版'), (1, '免费版')], default=2, verbose_name='收费类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.SmallIntegerField(choices=[(2, '#f28033'), (4, '#a2d148'), (3, '#ebc656'), (1, '#56b8eb'), (5, '#20bFA4'), (6, '#7461c2'), (7, '#20bfa3')], default=1, verbose_name='颜色')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.SmallIntegerField(choices=[(2, '已支付'), (1, '未支付')], verbose_name='状态')),
        ...
        migrations.AddField(
            ...
            name='invitee',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invites', to='web.UserInfo', verbose_name='邀请人'),
        ),
        migrations.AddField(
            model_name='projectuser',
            name='project',
        ...
        migrations.AddField(
            model_name='projectuser',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='web.UserInfo', verbose_name='用户'),
        ),
        migrations.AddField(
